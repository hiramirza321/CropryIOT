...
import com.lproject.cropryiot.ml.Cauli;
...
public class CauliflowerActivity extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image){
        ...
        try {
            Cauli cauli = Cauli.newInstance(getApplicationContext());
            ...
            Cauli.Outputs outputs = cauli.process(inputFeature0);
            ...
            String[] classes = {"Cauliflower Bacterial Spot Rot",
