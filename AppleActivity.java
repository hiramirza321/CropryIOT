...
import com.lproject.cropryiot.ml.Apple;
...
public class AppleActivity extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image){
        ...
        try {
            Apple apple= Apple.newInstance(getApplicationContext());
            ...
            Apple.Outputs outputs = apple.process(inputFeature0);
