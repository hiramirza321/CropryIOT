...
import com.lproject.cropryiot.ml.Grapes;
...
public class GrapeActivity extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image){
        ...
        try {
            Grapes grapes = Grapes.newInstance(getApplicationContext());
            ...
            Grapes.Outputs outputs = grapes.process(inputFeature0);
            ...
            String[] classes = {"Grapes Black Rot",
                    "Grapes Black Measles",
                    "Grapes Healthy Leaves",
                    "Result not Found",
                    "Grapes Leaf Blight"
            };
