...
import com.lproject.cropryiot.ml.Banana;
...
public class BananaActivity extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image){
        ...
        try {
            Banana banana = Banana.newInstance(getApplicationContext());
            ...
            Banana.Outputs outputs = banana.process(inputFeature0);
            ...
            String[] classes = {"Banana Cordana Disease",
